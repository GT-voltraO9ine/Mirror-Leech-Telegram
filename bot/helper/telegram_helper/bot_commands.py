...
class _BotCommands:
    def __init__(self):
        ...
        self.TarMirrorCommand = f'tarmirror{CMD_INDEX}'
        ...
        self.TarWatchCommand = f'tarwatch{CMD_INDEX}'
        ...
        self.QbTarMirrorCommand = f'qbtarmirror{CMD_INDEX}'
        ...
        self.TarLeechCommand = f'tarleech{CMD_INDEX}'
        self.ZipLeechCommand = f'zipleech{CMD_INDEX}'
        self.QbLeechCommand = f'qbleech{CMD_INDEX}'
        self.QbTarLeechCommand = f'qbtarleech{CMD_INDEX}'
        ...
        self.LeechTarWatchCommand = f'leechtarwatch{CMD_INDEX}'
