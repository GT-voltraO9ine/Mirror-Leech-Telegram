...
from bot import download_dict, download_dict_lock, BASE_URL, dispatcher, get_client, TORRENT_DIRECT_LIMIT, TAR_UNZIP_LIMIT, ZIP_UNZIP_LIMIT, STOP_DUPLICATE, WEB_PINCODE, QB_SEED, QB_TIMEOUT, LOGGER, STORAGE_THRESHOLD
            ...
            if tor_info.state == "metaDL":
                ...
                if not sizeChecked:
                    ...
                    if ZIP_UNZIP_LIMIT is not None and arch:
                        ...
                        mssg = f'Torrent limit is {TAR_UNZIP_LIMIT}GB'
