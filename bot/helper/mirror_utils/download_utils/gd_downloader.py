...
from bot import download_dict, download_dict_lock, ZIP_UNZIP_LIMIT, TAR_UNZIP_LIMIT, LOGGER, STOP_DUPLICATE, STORAGE_THRESHOLD, TORRENT_DIRECT_LIMIT
...
def add_gd_download(link, listener, is_gdtot):
    ...
    if any([ZIP_UNZIP_LIMIT, TAR_UNZIP_LIMIT, STORAGE_THRESHOLD, TORRENT_DIRECT_LIMIT]):
        arch = any([listener.extract, listener.isZip, listener.isTar])
        limit = None
        ...
        if ZIP_UNZIP_LIMIT is not None and arch:
            ...
            mssg = f'Tar limit is {TAR_UNZIP_LIMIT}GB'
