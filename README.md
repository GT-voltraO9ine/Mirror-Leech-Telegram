...
## By [GT-voltraO9ine](https://github.com/GT-voltraO9ine)
- qBittorrent
- Select files from Torrent before downloading using qbittorrent
- Leech (splitting, thumbnail for each user, setting as document or as media for each user)
- Size limiting for Torrent/Direct, Zip/Unzip,  Tar/Unzip, Mega and Clone
- Stop duplicates for all tasks except yt-dlp tasks
- Zip/Tar/Unzip G-Drive links
...
- Zip/Tar file/folder with or without password
...
- `TAR_UNZIP_LIMIT`: To limit the size of mirroring as Tar command. Don't add unit, the default unit is `GB`.
...
## Deploying on Heroku
<p><a href="https://github.com/GT-voltraO9ine/Mirror-Leech-Telegram/tree/heroku"> <img src="https://img.shields.io/badge/Deploy%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="170""/></a></p>
...
ping - Ping the Bot
auth - Authorise Chats
unauth - Unauthorise Chats
